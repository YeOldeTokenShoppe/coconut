...
//       camera.far = 100; // Adjust as needed
...
//       if (width <= 768) {
//         camera.position.set(0, 0, 50); // Move camera closer for small screens
//         camera.fov = 50; // Increase fov to reduce object size in view
//       } else {
//         camera.position.set(0, 0, 50); // Default for larger screens
//         camera.fov = 50; // Default fov
//       }
//       camera.updateProjectionMatrix();
//     };
